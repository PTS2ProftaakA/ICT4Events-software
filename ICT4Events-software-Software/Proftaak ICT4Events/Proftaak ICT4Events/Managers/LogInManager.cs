...
namespace Proftaak_ICT4Events
{
    class LogInManager
    {
        ...
        public LogInManager()
        {
            ...
            userRFID.TagLost += new TagEventHandler(userRFID_TagLost);
        ...
        void userRFID_Tag(object sender, TagEventArgs e)
        {
            //e.Tag is the actual RFID that belongs to the chip
            //e.protocol is the protocol that belongs to that chip
        }

        void userRFID_TagLost(object sender, TagEventArgs e)
        {
            //This method is for losing the tag when it moves out of scan range
        }
